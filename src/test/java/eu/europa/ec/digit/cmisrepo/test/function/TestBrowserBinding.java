...
public class TestBrowserBinding extends AbstractCmisTestClient{

	public static void main(String[] args) {
		Session cSession = getSession(NAME_USER_ADMIN, PSWD_USER_ADMIN, BindingType.BROWSER, NAME_TEST_REPO);
