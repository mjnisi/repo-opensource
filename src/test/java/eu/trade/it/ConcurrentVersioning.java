...
public class ConcurrentVersioning extends AbstractSessionTest {

	private static final Logger LOG = LoggerFactory.getLogger(ConcurrentVersioning.class);
	...
	public void run(Session session) throws Exception {
		...
		Assert.assertTrue(exception instanceof CmisInvalidArgumentException);
	...
	private static class Job implements Runnable {
		...
		public void run() {
			try {
				...
				LOG.debug(label + " checkout");
				Document PWC = (Document) session.getObject(PWCId);
				ObjectId lastId = PWC.checkIn(true, null, null, null);
