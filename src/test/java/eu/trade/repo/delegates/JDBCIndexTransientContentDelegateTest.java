...
public class JDBCIndexTransientContentDelegateTest extends BaseLobTestClass {
	...
	public void obtainWordPageByDocumentIdTest() throws Exception {
		...
		List<String> wordList = indexTransientContentDelegate.obtainWordPageByObjectId(TestConstants.TESTDOC_CMISID_INT, 0, 20);
		assertEquals(5, wordList.size());

		wordList = indexTransientContentDelegate.obtainWordPageByObjectId(TestConstants.TESTDOC_CMISID_INT, 0, 3);
		...
		wordList = indexTransientContentDelegate.obtainWordPageByObjectId(TestConstants.TESTDOC_CMISID_INT, 3, 3);
	...
	public void obtainWordPositionPageByDocumentIdTest() throws Exception {
		...
		wordList.add("three");
		wordList.add("two");
		List<TransientDTO> list = indexTransientContentDelegate.obtainWordPositionPageByObjectId(TestConstants.TESTDOC_CMISID_INT, wordList, 0, 3);
		assertEquals(3, list.size());
		list = indexTransientContentDelegate.obtainWordPositionPageByObjectId(TestConstants.TESTDOC_CMISID_INT, wordList, 0, 20);
