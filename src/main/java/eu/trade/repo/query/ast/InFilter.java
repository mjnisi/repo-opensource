...
public class InFilter extends CMISQueryFilter {
	...
	public InFilter(int t, String qualifier, String name, String not, Object values) {
	...
	public String getValue() {
		//TODO: should be comma separated
	...
	public Predicate toPredicate(CriteriaBuilder cb, Subquery<?> c, Path<?> property, Map<String, SortedSet<ObjectTypeProperty>> objectTypeProperties, Security security, Repository rep) {
		...
		//TODO: validate objectTypeProperties
